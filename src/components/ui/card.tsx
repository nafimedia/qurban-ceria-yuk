  ...
  "rounded-2xl border bg-card text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        feature: "shadow-md border-0 bg-gradient-to-br from-card to-muted/30",
        value: "shadow-md border-primary/10 hover:border-primary/30 hover:shadow-lg hover:-translate-y-1",
        service: "shadow-lg border-0 overflow-hidden",
      },
    },
    defaultVariants: {
      variant: "default",
